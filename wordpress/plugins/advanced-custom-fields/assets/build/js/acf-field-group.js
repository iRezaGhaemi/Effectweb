    ...
    onChangeSchemaProperty: function (e, $el) {
      ...
      request.done(response => {
        ...
        choices.forEach(function (choice) {
          $select.append($('<option></option>').val(choice.id).text(choice.text));
        });
...
(function ($, undefined) {
  ...
  var fieldManager = new acf.Model({
    ...
    actions: {
      ...
      add_field_below: 'onAddFieldBelow'
    },
    ...
    onAddFieldBelow: function ($el) {
      this.addField($el.parent(), $el);
    },
    ...
    addField: function ($list, $insertAfter) {
...
/* harmony import */ var _browse_fields_modal_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_browse_fields_modal_js__WEBPACK_IMPORTED_MODULE_7__);
